...
test('Render triangle with text "TRI", textColor: limegreen, shapeColor: maroon', () => {
...
test('Render circle with text "CIR", textColor: black, shapeColor: red', () => {
...
test('Render square with text "SQU", textColor: yellow, shapeColor: black', () => {
